...
arte::arte(std::string n, std::string d, std::string a, std::string dc, double v,
bool p, std::string id, std::string ar, std::string to, 
bool viv, std::list<std::string> esp) : biblioteca(n, d, a, dc, v, p, id), artista(ar), tipoOpera(to),
