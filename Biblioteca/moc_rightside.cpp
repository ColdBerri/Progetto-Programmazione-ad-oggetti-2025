...
QT_MOC_LITERAL(1, 10, 12), // "itemToDelete"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "itemName"
QT_MOC_LITERAL(4, 33, 12), // "eliminazione"
...
void rightside::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&rightside::itemToDelete)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void rightside::itemToDelete(const QString & _t1)
{
